...
const Header: React.FC = () => {
    ...
    return (
        <header className="bg-gradient-to-br from-azul-escuro to-verde-vibrante text-white p-[25px_20px] text-center rounded-b-[20px] mb-10 shadow-lg relative overflow-hidden animate-headerReveal">
            <div 
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-[10px]">Soluções em Marketing Digital e Automação</h1>
                <p className="max-w-3xl mx-auto">Impulsione suas vendas com nossas estratégias avançadas</p>
            </div>
        </header>
    );
};
